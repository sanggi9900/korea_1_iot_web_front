...
console.log(`Age: ${age}, IsStudent: ${isStudent}`); // Age: 33, IsStudent: true
...
console.log(`${product.id}, ${product.name}, ${product.price}`); // qwe123, 황상기, 1000