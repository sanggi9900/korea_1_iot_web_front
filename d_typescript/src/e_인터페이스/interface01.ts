...
const student1 = new Student('황현지', 30); // Hello, my name is 황현지
const student2 = new Student('권세혁', 40); // Hello, my name is 권세혁
