...
// const calculatePay =  function(hours, rate){
...
calculatePay(160, 22);
calculatePay(180, 18);
// console.log(`직원 A : ${hours}, 시급 ${rate}, 급여 ${}`);
// console.log(`직원 B : ${hours}, 시급 ${rate}, 급여 ${calculatePay(160, 22)}`);
// console.log(`직원 C : ${hours}, 시급 ${rate}, 급여 ${calculatePay(180, 18)}`);
