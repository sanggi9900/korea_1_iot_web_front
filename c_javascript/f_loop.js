...
// ! 반복문(Loop)
// : 동일한 코드 블록을 여러 번 실행 할 수 있도록 하는 제어문

//# 반복문의 종류
// : for반복문, while반복문, do-while반복문  (for...in반복문)
// +) 배열 (Array)
// : 여러 개의 변수를 한 번에 선언하여 다룰 수 있는 자료형 (참조 자료형)

// - 순차적으로 저장 (데이터에 순서가 존재)
// - 기본으로 부여되는 순서 Index(인덱스, 시작이 0부터 1씩 증가하는 수)
// - 배열 내부의 각데이터를 요소라고 부름

// 배열 선언 방법
// '변수' | '선언' 키워드 = [요소1, 요소2, 요소3, ....]
...
// 행에 대한 반복 : 5번 실행
console.log('===별찍기===');
for(let i = 0; i <= 5 ;i++ ) { // 1부터 5까지 5번 실행
  let stars = '';
...
console.log('=== 별찍기3 ===');
/* 행의 시작시 공백이 부여 문자열 안에 ''
각행의 차례마다 그 개수의 별이 찍힘
*/
