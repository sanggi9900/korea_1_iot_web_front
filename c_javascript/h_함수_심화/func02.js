...
// >> 콜백함수의 인자값은 필수 사상 X (value만 사용하는 경우가 많음)
//    : 사용하지 않는 인자값은 생략 가능
...
const evenNummbers = basicArray.filter(function (value) {
...
console.log(`짝수만 추출한 배열: ${evenNummbers}`); // 짝수만 추출한 배열: 0, 2, 4
...
// 3. 전체 배열의 요소 중 문자열 길이가 4보다 큰 요소만 반환 - filter
// > 문자열데이터.length
