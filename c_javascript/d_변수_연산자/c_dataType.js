...
// 자료형 (data type)
// - 기본자료형 (string, number, boolean, null & undefined)
...
// let multiLine = '안녕하세요 반갑습니다.'; 
// - Error: 일반 따옴표는 줄바꿈을 인식하지 못함
...
// object라뜨면 아무것도 존재 하지 않는다

console.log(
  // value 변수 타입이'object'이면서(and) 값이 존재 하지 않는경우 'null'을 출력
...
console.log(Number(notANumber)); // NaN: Not A Number - 숫자로 변경할 수 없는 값을 변환 시도할 경우 나온다
...
// false:: false, 0, '', null, udefined, NaN
